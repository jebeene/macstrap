...
export MACSTRAP_INSTALL_LOG_FILE="/var/log/macstrap-install.log"
...
source "$MACSTRAP_INSTALL/config/all.sh"
source "$MACSTRAP_INSTALL/login/all.sh"
source "$MACSTRAP_INSTALL/post-install/all.sh"